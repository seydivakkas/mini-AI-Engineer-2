...
- **Tamamlanan:** Gün 01 - Gün 257 (%100 eksiksiz tamamlandı ve test edildi - FAZ 1 - FAZ 12 TAMAMLANDI, FAZ 13 Gün 241-257 TAMAMLANDI).
- **Sıradaki Büyük Faz:** FAZ 13: Embodied AI & Fiziksel Yapay Zeka / Robotik (Gün 241 - Gün 260).
- **Sıradaki Gün:** Gün 258 (`day-258-zero-shot-unseen-object-grasping` — Sıfır Örnekli (Zero-Shot) Görülmemiş Nesneleri Kavrama ve Ayırma).
