"""
ORPO Dil Modeli Mimarisi (Day 112).
Causal Transformer otoregresif mimarisi ve çiftli diziler için birleşik log-olasılık motoru.
"""
...
from .orpo_kaybi import hesapla_token_bazli_logprob
...
class ORPODilModeli(nn.Module):
    """ORPO Eğitimi için Tekil Model Mimarisi (Referans Modelsiz!)."""
