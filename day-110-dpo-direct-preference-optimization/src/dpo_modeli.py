"""
DPO Dil Modeli Mimarisi (Day 110).
Otoregresif Transformer mimarisi ve çiftli diziler için log-olasılık çıkarım motoru.
"""
...
from .dpo_kaybi import hesapla_dizi_logprob
...
class DPODilModeli(nn.Module):
    """DPO Eğitimi için Otoregresif Transformer Dil Modeli."""
